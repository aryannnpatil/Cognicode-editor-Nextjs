...
const templates: TemplateOption[] = [
  ...
  },
  {
    ...
    color: "#092E20",
    popularity: 4,
    tags: ["Python", "Backend", "Web Framework"],
    features: ["ORM", "Admin Interface", "Authentication System"],
    category: "backend",
  },
];
  ...
  const handleCreateProject = () => {
    if (selectedTemplate) {
      const templateMap: Record<
        string,
        "REACT" | "NEXTJS" | "EXPRESS" | "VUE" | "HONO" | "ANGULAR" | "DJANGO"
      > = {
        react: "REACT",
        nextjs: "NEXTJS",
        express: "EXPRESS",
    ...
    >
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        {step === "select" ? (
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#ff7b1b] flex items-center gap-2">
                <Plus size={24} className="text-[#ff7b1b]" />
                Select a Template
              </DialogTitle>
              <DialogDescription>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {filteredTemplates.length > 0 ? (
                    filteredTemplates.map((template) => (
                      <div
                        key={template.id}
                        className={`relative flex p-6 border rounded-lg cursor-pointer hover:scale-[1.02]
                          ${
                            selectedTemplate === template.id
                              ? "border-[#ff7b1b] shadow-[0_0_0_1px_#ff7b1b],0_8px_20px_rgba(255,123,27,0.15)]"
                              : "hover:border-[#ff7b1b] shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.1)]"
                          }
                              `}
                      ...
                      >
                        ...
                        {selectedTemplate === template.id && (
                          <div className="absolute top-2 left-2 bg-[#ff7b1b] text-white rounded-full p-1">
                            <Check size={14} />
                          </div>
                        )}
            ...
            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  className="bg-[#ff7b1b] hover:bg-[#e67317] text-white"
          ...
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#ff7b1b]">
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              <div className="p-4 shadow-[0_0_0_1px_#ff7b1b,0_8px_20px_rgba(255,123,27,0.15)] rounded-lg border">
                  ...
                  {templates
                    ...
                    ?.features.map((feature) => (
                      <div key={feature} className="flex items-center gap-2">
                        <Zap size={14} className="text-[#ff7b1b]" />
