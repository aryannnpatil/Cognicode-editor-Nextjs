...
export default function ProjectTable({
  ...
  const copyProjectUrl = (projectId: string) => {
    const copyProjectUrl = `${window.location.origin}/playground/${projectId}`;
    navigator.clipboard.writeText(copyProjectUrl);
            ...
            {projects.map((project) => (
              <TableRow key={project.id}>
                ...
                <TableCell>
                  <Badge
                    variant="outline"
                    className="bg-[#ff7b1b15] text-[#ff7b1b] border-[#ff7b1b]"
                  >
                    {project.template}
                  </Badge>
                </TableCell>
